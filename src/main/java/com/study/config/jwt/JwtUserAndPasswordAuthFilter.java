...
public class JwtUserAndPasswordAuthFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public JwtUserAndPasswordAuthFilter(AuthenticationManager authenticationManager, JwtConfig jwtConfig, SecretKey secretKey) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        try {
            UserAndPasswordAuthRequest authenticationRequest =
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        String token = Jwts.builder()
                ...
                .setExpiration(new Timestamp(new Date().getTime() + jwtConfig.getExpirationDate()))
                .signWith(secretKey)
                .compact();
